...
Current governed execution support is deliberately limited to individually approved proposal execution for `magick-ai/trash-post`, `magick-ai/create-draft`, `magick-ai/update-post`, `magick-ai/set-post-terms`, and `magick-ai/reply-comment`.
...
4. Open Magick AI > Adapter to create the OpenClaw handoff.
...
No. Adapter only executes abilities that are explicitly allowlisted. The current minimal execution allowlist contains `magick-ai/trash-post`, `magick-ai/create-draft`, `magick-ai/update-post`, `magick-ai/set-post-terms`, and `magick-ai/reply-comment`.
