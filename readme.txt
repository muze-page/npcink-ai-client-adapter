...
Current governed execution support is deliberately limited to individually approved proposal execution for `magick-ai/trash-post`, `magick-ai/create-draft`, `magick-ai/update-post`, `magick-ai/set-post-terms`, `magick-ai/reply-comment`, and `magick-ai/approve-comment`.
