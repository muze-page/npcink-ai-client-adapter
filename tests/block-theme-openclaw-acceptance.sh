...
REPORT_PATH="${MAA_ADAPTER_BLOCK_THEME_OPENCLAW_ACCEPTANCE_OUT:-$ROOT_DIR/build/block-theme-openclaw-acceptance/report.json}"
...
MAA_ADAPTER_BLOCK_THEME_OPENCLAW_ACCEPTANCE_OUT="$REPORT_PATH" run_wp eval-file "$ROOT_DIR/tests/block-theme-openclaw-acceptance.php"
