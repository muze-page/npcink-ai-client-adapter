...
foreach (
	array(
		...
		'Open in Core',
			...
			'data-maa-tab-target="maa-connect"',
			'data-maa-tab-target="maa-proposal"',
			'data-maa-tab-target="maa-advanced"',
			'class="maa-tab-panel maa-workspace maa-workspace-main',
			'class="maa-tab-panel maa-section maa-section-proposal',
		...
		'Diagnostics URLs',
		'Route catalog',
			'id="maa-advanced" class="maa-tab-panel maa-section',
		'Proposal list',
			'Proposal detail',
			'Plan to proposals',
			'Commit preflight',
