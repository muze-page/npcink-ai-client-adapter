...
foreach (
	array(
		...
		'magick_ai_cloud_addon_download_media_derivative_artifact',
		'magick_ai_core_build_media_derivative_ability_input',
		"'watermark_enabled'",
