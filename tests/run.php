...
foreach (
	array(
		...
		'approve-and-execute',
		'Current execution allowlist: magick-ai/trash-post, magick-ai/create-draft, magick-ai/update-post, magick-ai/set-post-terms, magick-ai/reply-comment, magick-ai/approve-comment',
