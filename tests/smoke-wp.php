...
maa_adapter_smoke_assert( 'add_breadcrumbs' === (string) ( $help['openclaw_recipes']['block_theme_site_plan']['conversation_contract']['planner_prompt_guidance']['output_shape']['intent'] ?? '' ), 'adapter help exposes supported block theme planner output shape' );
